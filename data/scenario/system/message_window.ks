;メッセージレイヤの定義
		...
		[position width=1920 height=1080 top=0 left=0 ]


		
			[position page=fore frame="msg_w.png" margint=930 marginl=10 marginr=20 marginb=10 vertical=false opacity="180" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=667 y=392 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=1920 height=1080 top=0 left=0 ]
